...
namespace TestDemo
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            string sql = "select * from record where pass=1 and aid =" +18+ " and LOWER(username)='tanxi'   and subtime > '" + dt_ + " 00:00:01' and  subtime < '" + dt_ + " 23:59:59' ";
            SQLiteHelper.SQLiteHelper.recorderDbCheck(sql);
